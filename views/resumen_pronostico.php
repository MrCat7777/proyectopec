...
<body>
    <div class="container">
        <h2 style="color: #ccff00;" class="seq-1">¡Pronóstico Registrado!</h2>
        
        <div class="card summary seq-2">
            ...
            <div style="background: rgba(0,0,0,0.3); padding: 15px; border-radius: 10px; margin: 20px 0;">
                <p style="color: #ccff00; font-size: 1.2rem; font-weight: bold; margin-bottom: 5px;">Análisis del Sistema:</p>
        ...
        <div class="grid-2 seq-3">
            <a href="registrar_pronostico.php" class="btn-pronosticar" style="text-align: center; padding: 15px; margin-top:0;">Hacer otro pronóstico</a>
            <a href="ver_pronosticos.php" class="btn-pronosticar" style="background: rgba(255,255,255,0.1); border-color: rgba(255,255,255,0.3); color: #fff; text-align: center; padding: 15px; margin-top:0;">Ver Ranking Global</a>
        </div>
    </div>
</body>
</html>